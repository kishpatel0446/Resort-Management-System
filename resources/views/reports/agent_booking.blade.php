...
<div class="container mt-4">
    ...
    <h2 class="mb-4 text-center text-primary">Agent Bookings</h2>

    <div class="card shadow-lg mb-4">
        <div class="card-body">
            <form id="filterForm" method="GET" action="{{ route('reports.agent_booking') }}">
...
<script>
    function applyFilter() {
        ...
        $.ajax({
            url: "{{ route('reports.agent_booking') }}",
            method: 'GET',
            data: {
                date: date,
                name: name,
            ...
            success: function(response) {
                $('#bookingTableBody').html(response.table_html);
            }
        });
    }
